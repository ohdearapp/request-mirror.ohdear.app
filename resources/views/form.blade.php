                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input
                                ...
                                value="1"
                                {{ old('terms') ? 'checked' : '' }}
                                class="w-4 h-4 border border-gray-300 dark:border-gray-700 rounded bg-white dark:bg-gray-800 focus:ring-2 focus:ring-primary text-primary transition-colors @error('terms') border-red-500 dark:border-red-500 @enderror"
                            >
                        </div>
                        <label for="terms" class="ml-3 text-sm text-gray-900 dark:text-white">
                            Accept our terms and conditions <span class="text-red-500">*</span>
                        </label>
                    </div>
                    @error('terms')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
